using GoogleAuthorizationAPI.Models.Identity;
using GoogleAuthorizationAPI.Models;
...
builder.Services.AddTransient<ITokenHandler, GoogleAuthorizationAPI.Service.TokenHandler>();
